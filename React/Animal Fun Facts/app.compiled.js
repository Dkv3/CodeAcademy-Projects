...
var background = _react2.default.createElement("img", { "class": "background", alt: "ocean", src: "/images/ocean.jpg" });
...
function displayFact(e) {
  ...
  var index = Math.floor(Math.random() * selectedAnimal.facts.length);
  var funFact = selectedAnimal[index];
